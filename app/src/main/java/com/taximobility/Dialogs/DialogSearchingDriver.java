package com.taximobility.Dialogs;
...
import com.taximobility.databinding.DialogSearchDriverBinding;
...
public class DialogSearchingDriver extends Dialog {
    ...
    public void onBackPressed() {
        DialogMessage.get(getContext()).setMessage("Are you sure want to cancel Request?").Callback(this::CancelRide).show();
    }
